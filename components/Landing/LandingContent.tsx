...
export default function LandingContent() {
    return (
        <section>
            <div className='hidden sm:flex flex-col items-center h-full font-sniglet md:mt-2 lg:mt-3'>
                <Image src={Wordmark} alt='Wordmark' className='sm:w-64 md:w-80 lg:w-96 xl:w-128 2xl:w-160 lg:mt-8' />
